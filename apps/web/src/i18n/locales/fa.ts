...
export const fa: Dict = {
  ...
  'chat.amrBalanceGate.message': 'اعتبار شما برای اجرای این وظیفه کافی نیست. طرح مناسب را انتخاب کنید تا بلافاصله شروع شود.',
  ...
  'chat.amrBalanceGate.plansCta': 'مشاهده طرح‌ها',
  'chat.amrBalanceGate.signedOutMessage': 'برای شروع وظایف، وارد Open Design Cloud شوید و یک طرح انتخاب کنید.',
