...
export const en: Dict = {
  ...
  'chat.amrBalanceGate.message': 'You don\'t have enough credits to run this task. Choose a plan that fits, and it can start right away.',
  ...
  'chat.amrBalanceGate.plansCta': 'View plans',
  'chat.amrBalanceGate.signedOutMessage': 'Sign in to Open Design Cloud and pick a plan to start tasks.',
